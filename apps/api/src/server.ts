import { z } from "zod";
import { AIChatService, createCasaPraticaAgentSystem, loadAgentPrompts, OpenAIManagerRunner, registerProductResearchTools, ToolRegistry } from "@casapratica/agents";
import { createPrismaClient, PrismaConversationSessionRepository, PrismaIntegrationRepository, PrismaOAuthStateRepository, PrismaResearchRepository, PrismaTraceRepository } from "@casapratica/database";
...
import { ProductResearchService } from "@casapratica/strategy";
