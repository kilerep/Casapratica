...
export interface HttpClient { request<T>(i: { url: string; method: "GET" | "POST" | "DELETE"; headers?: Readonly<Record<string, string>>; body?: URLSearchParams | string; timeoutMs?: number; essential?: boolean; responseType?: "json" | "text" }): Promise<T> }
